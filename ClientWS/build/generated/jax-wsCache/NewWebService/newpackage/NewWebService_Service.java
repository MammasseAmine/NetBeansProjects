 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://newpackage/", wsdlLocation = "http://localhost:8080/NewWebService/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://newpackage/", "NewWebService");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://newpackage/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://newpackage/", "NewWebServicePort"), NewWebService.class, features);
    }
